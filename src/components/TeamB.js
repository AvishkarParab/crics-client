...
toast.success(`Team ${bname} Updated Successfully !!`,{
    position: "top-center",
    transition: Flip,
  ...
  return (
    <>
        {/* <div className='mt-2 text-center'>
            <h2 className=''>{bname} Details</h2>
          </div> */}
          <div className='headerbox d-flex align-items-center justify-content-center'><h2 className=''>{bname} Details</h2></div>

          <div className='mt-3 bowlbox container'>
          ...
          <br />
            ...
            <div className='mt-4 text-end'>
              <button className='btn btn-danger' type='submit' onClick={update}>Go Play</button>
            </div>
           </form>
          </div>
    </>
