...
const SelectBowl = ({bat,open,bowl,setBowl}) => {
...
const [player,setPlayer] = useState({
  ...
  const select = async()=>{
    try{
      ...
      const res = await fetch('/selectbowl',{
        method:"GET",
        headers:{
          "Content-Type": "application/json",
        }
    ...
    <>
          ...
          <br />
            ...
            <div className='mt-2 text-center'>
              <button className='btn btn-outline-warning' type='submit' onClick={check} style={{borderRadius:"20px"}}>Select</button>
              <button className='btn btn-outline-warning mx-5' type='submit' onClick={proceed} style={{borderRadius:"20px"}}>Proceed</button>
            </div>
           </form>
          </div>
    </>
